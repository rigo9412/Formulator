...
class FixedHoloDatePickerDialog(context: Context, callBack: DatePickerDialog.OnDateSetListener,
    ...
    init {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            try {
                ...
                val delegateField = this.findField(
                        DatePicker::class.java,
                        delegateClass,
                        "mDelegate"
                )
                ...
                val spinnerDelegateClass = Class.forName(
